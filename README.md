...
4.	Adatbázis menü: a választott adatbázisból jelenít meg adatokat				(2 p)
Ehhez 3 tábla adatait használja fel az adatbázisból.
Használjon Repository-t az adatbázis műveletekhez
...
8.	CRUD menü: Az oldalon valósítson meg egy CRUD (Create, Read, Update, Delete) 	(3 p)
...
9.	RESTful menü: Valósítson meg az alkalmazásban egy RESTful API-t.			(2 p)
...
11.	Alkalmazását töltse fel és valósítsa meg Linux-os tárhelyen.				(2 p)
(Kötelező elem! A működés ez alapján lesz javítva)	
12.	Használják a GitHub (github.com) verziókövető rendszert. 				(2 p)
...
13.	A GitHub-on a projektmunka módszert alkalmazzák: látszódjék, 			(2 p)
